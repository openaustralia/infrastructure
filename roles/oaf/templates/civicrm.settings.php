...
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/wp-content/plugins/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://oaf.org.au.dev/' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/wp-content/plugins/files/civicrm/templates_c//mail.log' );
// }
