...
moved {
  ...
  to   = module.righttoknow.cloudflare_record.rtk_root
}

moved {
  from = cloudflare_record.rtk_www
  to   = module.righttoknow.cloudflare_record.rtk_www
}

moved {
  from = cloudflare_record.rtk_test
  to   = module.righttoknow.cloudflare_record.rtk_test
}

moved {
  from = cloudflare_record.rtk_www_test
  to   = module.righttoknow.cloudflare_record.rtk_www_test
}

moved {
  from = cloudflare_record.rtk_mx1
  to   = module.righttoknow.cloudflare_record.rtk_mx1
}

moved {
  from = cloudflare_record.rtk_mx2
  to   = module.righttoknow.cloudflare_record.rtk_mx2
}

moved {
  from = cloudflare_record.rtk_mx3
  to   = module.righttoknow.cloudflare_record.rtk_mx3
}

moved {
  from = cloudflare_record.rtk_mx4
  to   = module.righttoknow.cloudflare_record.rtk_mx4
}

moved {
  from = cloudflare_record.rtk_mx5
  to   = module.righttoknow.cloudflare_record.rtk_mx5
}

moved {
  from = cloudflare_record.rtk_server
  to   = module.righttoknow.cloudflare_record.rtk_server
}

moved {
  from = cloudflare_record.rtk_spf
  to   = module.righttoknow.cloudflare_record.rtk_spf
}

moved {
  from = cloudflare_record.rtk_google_site_verification
  to   = module.righttoknow.cloudflare_record.rtk_google_site_verification
}

moved {
  from = cloudflare_record.rtk_facebook_domain_verification
  to   = module.righttoknow.cloudflare_record.rtk_facebook_domain_verification
}

moved {
  from = cloudflare_record.rtk_default_domainkey
  to   = module.righttoknow.cloudflare_record.rtk_default_domainkey
}

moved {
  from = cloudflare_record.rtk_google_domainkey
  to   = module.righttoknow.cloudflare_record.rtk_google_domainkey
}

moved {
  from = cloudflare_record.rtk_dmarc
  to   = module.righttoknow.cloudflare_record.rtk_dmarc
}

moved {
  from = aws_instance.righttoknow
  to   = module.righttoknow.aws_instance.righttoknow
}

moved {
  from = aws_eip.righttoknow
  to   = module.righttoknow.aws_eip.righttoknow
}

moved {
  from = aws_ebs_volume.righttoknow_data
  to   = module.righttoknow.aws_ebs_volume.righttoknow_data
}

moved {
  from = aws_volume_attachment.righttoknow_data
  to   = module.righttoknow.aws_volume_attachment.righttoknow_data
}
