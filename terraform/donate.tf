...
moved {
  from = module.oaf.cloudflare_record.oaf_donate
  to   = cloudflare_record.oaf_donate
}
...
moved {
  from = module.oaf.cloudflare_record.oaf_donate_email
  to   = cloudflare_record.oaf_donate_email
}
...
moved {
  from = module.oaf.cloudflare_record.oaf_donate_domainkey
  to   = cloudflare_record.oaf_donate_domainkey
}
...
moved {
  from = module.oaf.cloudflare_record.oaf_donate_spf
  to   = cloudflare_record.oaf_donate_spf
}
...
moved {
  from = module.oaf.cloudflare_record.oaf_donate_mxa
  to   = cloudflare_record.oaf_donate_mxa
}
...
moved {
  from = module.oaf.cloudflare_record.oaf_donate_mxb
  to   = cloudflare_record.oaf_donate_mxb
}
