...
yaml-lint: venv
	.venv/bin/yamllint roles/internal/**/*.yml roles/*.yml site.yml

ansible-lint: venv
	ANSIBLE_ROLES_PATH=roles:roles/internal:roles/external .venv/bin/ansible-lint roles/internal/**/*.yml roles/*.yml site.yml
